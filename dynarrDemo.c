...
int main() {
	...
	* INT MULTI DYNAMIC ARRAYS
	(!) SEE: ALL _am() FUNC CALLS HAVE &MULTI_ARR_NAME '&' TO PASS ADDRESS (!)
	**************************************************************************/
	printf("\n============================================================\n");
	printf("===================== 2D DYNAMIC ARRAY =====================\n");
	printf("============================================================\n");
	_am(&int_multi_arr[0],0,n0(1)); /* add values to 1st dyn arr in array */
	_am(&int_multi_arr[0],2,n0(6)); /* add values to 1st dyn arr in array */
	_am(&int_multi_arr[0],3,n0(9)); /* add values to 1st dyn arr in array */
	_am(&int_multi_arr[1],0,n0(2)); /* add values to 2nd dyn arr in array */
	_am(&int_multi_arr[2],0,n0(3)); /* add values to 3rd dyn arr in array */
	...
	printf("int_multi_arr length: %d\n",_lm(int_multi_arr[0]));
	printf("int_multi_arr index of element 6: %d\n",_im(int_multi_arr[0], n0(6)));
	_pm(int_multi_arr[0],2,n0(7)); /* put 7 in existing int_multi_arr[0] idx 2 */
	printf("int_multi_arr swap, index 2 - index 3: %d - %d\n",_eim(int_multi_arr[0],2),_eim(int_multi_arr[0],3));
	_sm(int_multi_arr[0],2,3); /* swap int_multi_arr[0] index 2 & index 3 */
	printf("int_multi_arr swap, index 2 - index 3: %d - %d\n",_eim(int_multi_arr[0],2),_eim(int_multi_arr[0],3));
	_dm(int_multi_arr[0],3); /* delete int_multi_arr[0] index 3 */
	_am(&int_multi_arr[0],3,n0(8)); /* add 8 to int_multi_arr[0] index 3 */
	printf("int_multi_arr new index 3 element: %d\n\n",_eim(int_multi_arr[0],3));
	/*************************************************************************
	...
	**************************************************************************/
	...
	printf("char_multi_arr new index 3 element: %s\n\n",_ecm(char_multi_arr[0],3));
